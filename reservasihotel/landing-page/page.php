    ...
    <section id="home" class="home">
        <div class="jumbotron jumbotron-fluid" id="banner" style="background-image: url(img/banner-bk.jpg);">
            <div class="container text-center text-md-left">
                <header>
                    <div class="row">
                        ...
                        <div class="col-6 align-self-center text-right">
                            <a href="#home" class="text-white lead">HOME</a>
                            <a href="#aboutus" class="text-white lead">ABOUT US</a>
                            <a href="#ourteam" class="text-white lead">OUR TEAM</a>
                            <a class="text-white lead" href="<?php echo site_url('login') ?>"  role="button" >
                ...
                <a href="#login" data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="btn my-4 font-weight-bold atlas-cta cta-green">Get Started</a>
            </div>
        </div>
    </section>
    <!-- three-blcok -->
